...
def main():
    ...
    # Start figure
    figname = "fig_hovmoller_"+expndg+"_"+varName+".png"
    fntsz   = 12
    cmap    = plt.cm.bwr
    fig     = plt.figure(figsize=(10, 12), constrained_layout=True)
    # Use gridspec to help size elements of plot; small top plot and big bottom plot
    #gs      = gridspec.GridSpec(nrows=2, ncols=3, height_ratios=[1, 6], hspace=0.03)
    gs      = fig.add_gridspec(nrows=3, ncols=3, height_ratios=[1, 5, 1], hspace=0.03)
    ...
    for ip in range(3):
        ...
        #cbar.set_label('m $s^{-1}$',fontsize = fntsz)
